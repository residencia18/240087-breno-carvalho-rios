...
namespace AvaliacaoDotNet
{
    public abstract class Pessoa
    {
        ...
        public static bool IsCpfUnico(string cpf, List<Pessoa> pessoas)
        {
            // Verifica se o CPF já existe na lista de pessoas
            return !pessoas.Any(pessoa => pessoa.Cpf == cpf);
        }
        ...
        public static DateTime ObterDataDeNascimento()
        {
            ...
            do
            {
                ...
                {
                    Console.WriteLine("\n\tOps, a data de nascimento é inválida. Por favor, digite novamente.");
                    dataValida = false;
                }
